...
                        [io.github.qishr.cascara.common.diagnostic.LocalizableException](LocalizableException.md)<br/>
                                io.github.qishr.cascara.common.diagnostic.LocalizableIOException<br/>
<br/>

----

<span style="font-family: monospace; font-size: 80%;">public class __LocalizableIOException__<br/>extends [LocalizableException](LocalizableException.md)
</span>
...
### Methods inherited from [LocalizableException](LocalizableException.md)
