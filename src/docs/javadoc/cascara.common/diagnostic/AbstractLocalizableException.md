...
                        io.github.qishr.cascara.common.diagnostic.AbstractLocalizableException<br/>
<br/>
...
<span style="font-family: monospace; font-size: 80%;">public class __AbstractLocalizableException__<br/>extends [Exception](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Exception.html)
</span>
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| AbstractLocalizableException([DiagnosticCode](code/DiagnosticCode.md) code, [Object](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html)[] details)                                                                                                           |             |
| AbstractLocalizableException([Throwable](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Throwable.html) cause, [DiagnosticCode](code/DiagnosticCode.md) code, [Object](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html)[] details) |             |
...
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| public static [DiagnosticLocalizer](DiagnosticLocalizer.md)                                           | [getLocalizer](#getlocalizer)()                                                              |                                                                          |
...
<span style="font-family: monospace; font-size: 80%;">public static [DiagnosticLocalizer](DiagnosticLocalizer.md) __getLocalizer__()</span>
