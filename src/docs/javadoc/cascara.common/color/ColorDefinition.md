...
        io.github.qishr.cascara.common.color.ColorDefinition<br/>
<br/>
...
| ColorDefinition([RgbaColor](RgbaColor.md) color)                                                                       |                                                                                      |
| ColorDefinition([HsbaColor](HsbaColor.md) color)                                                                       |                                                                                      |
...
| public void                                                                                         | [copyTo](#copyto)([ColorDefinition](ColorDefinition.md) to)                                                                                                       |                                                                                      |
...
<span style="font-family: monospace; font-size: 80%;">public void __copyTo__([ColorDefinition](ColorDefinition.md) to)</span>
