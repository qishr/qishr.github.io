...
        io.github.qishr.cascara.common.util.ArchiveFile.EntryInfo<br/>
<br/>
Enclosing Class:<br/>
    [io.github.qishr.cascara.common.util.ArchiveFile](ArchiveFile.md)


----

<span style="font-family: monospace; font-size: 80%;">public static class __EntryInfo__</span>
...
|--------------------------------------------------------------------------------------------------------------|-------------|
| EntryInfo([String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) path) |             |
