...
        io.github.qishr.cascara.common.data.TextualTree<br/>
<br/>

----

<span style="font-family: monospace; font-size: 80%;">public class __TextualTree__</span>
...
|---------------|---------------------------|
| TextualTree() | Constructs an empty Tree. |
