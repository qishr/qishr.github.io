...
    [Processor](Processor.md), [Iterator](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/Iterator.html)<[Event](../streaming/Event.md)>, [AutoCloseable](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/AutoCloseable.html)
...
|------------------------------------------------|-----------------------|----------------------------------------------------------|
| public abstract [Event](../streaming/Event.md) | [next](#next)()       | Advances to the next event in the stream and returns it. |
...
<span style="font-family: monospace; font-size: 80%;">public abstract [Event](../streaming/Event.md) __next__()</span>
