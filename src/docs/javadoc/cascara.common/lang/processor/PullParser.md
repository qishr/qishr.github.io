...
    [Processor](Processor.md), [Iterator](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/Iterator.html)<E>, [AutoCloseable](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/AutoCloseable.html)

All Known Implementing Classes:<br/>
    [JsonPullParser](../../../cascara.lang.json/processor/JsonPullParser.md), [YamlPullParser](../../../cascara.lang.yaml/processor/YamlPullParser.md)
...
|-------------------------|-----------------------|----------------------------------------------------------|
| public abstract E       | [next](#next)()       | Advances to the next event in the stream and returns it. |
...
<span style="font-family: monospace; font-size: 80%;">public abstract E __next__()</span>
