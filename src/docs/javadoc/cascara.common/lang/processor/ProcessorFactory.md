...
<span style="font-family: monospace; font-size: 80%;">public class __ProcessorFactory__<br/>extends [AbstractServiceProviderFactory](../../service/AbstractServiceProviderFactory.md)
</span>
