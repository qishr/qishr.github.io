...
        io.github.qishr.cascara.common.lang.plain.PlainNode<br/>
<br/>
All Implemented Interfaces:<br/>
    [AstNode](../ast/AstNode.md)

Direct Known Subtypes:<br/>
    [PlainMapEntryNode](PlainMapEntryNode.md), [PlainScalarNode](PlainScalarNode.md), [PlainSequenceNode](PlainSequenceNode.md), [PlainMapNode](PlainMapNode.md)


----

<span style="font-family: monospace; font-size: 80%;">public abstract class __PlainNode__</span>
