...
<span style="font-family: monospace; font-size: 80%;">public class __YamlAnchor__<br/>extends [YamlNode](YamlNode.md)
</span>
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| YamlAnchor(int line, int column, [String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) name, [YamlNode](YamlNode.md) node) |             |
