...
                [io.github.qishr.cascara.lang.yaml.util.YamlOptions](YamlOptions.md)<br/>
                        io.github.qishr.cascara.lang.yaml.util.YamlOptions.ImmutableYamlOptions<br/>
<br/>
Enclosing Class:<br/>
    [io.github.qishr.cascara.lang.yaml.util.YamlOptions](YamlOptions.md)


----

<span style="font-family: monospace; font-size: 80%;">public static class __ImmutableYamlOptions__<br/>extends [YamlOptions](YamlOptions.md)
</span>
...
|-------------------------------------------------------------|-------------|
| ImmutableYamlOptions([YamlOptions](YamlOptions.md) options) |             |
...
|--------------------------------------|----------------------------------------------------------------------------|-------------|
| public [YamlOptions](YamlOptions.md) | [setAllowComments](#setallowcomments)(boolean val)                         |             |
| public [YamlOptions](YamlOptions.md) | [setAllowUnicode](#setallowunicode)(boolean val)                           |             |
| public [YamlOptions](YamlOptions.md) | [setExplicitStart](#setexplicitstart)(boolean val)                         |             |
...
<span style="font-family: monospace; font-size: 80%;">public [YamlOptions](YamlOptions.md) __setAllowComments__(boolean val)</span>
