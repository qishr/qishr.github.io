...
| public [JsonMapEntryNode](JsonMapEntryNode.md)                                                                                                   | [getEntry](#getentry)([String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) key)                                                                                           | Convenience method for internal use and testing. |
