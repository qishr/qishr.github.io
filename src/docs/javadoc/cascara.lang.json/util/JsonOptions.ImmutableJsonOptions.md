...
                [io.github.qishr.cascara.lang.json.util.JsonOptions](JsonOptions.md)<br/>
                        io.github.qishr.cascara.lang.json.util.JsonOptions.ImmutableJsonOptions<br/>
<br/>
Enclosing Class:<br/>
    [io.github.qishr.cascara.lang.json.util.JsonOptions](JsonOptions.md)


----

<span style="font-family: monospace; font-size: 80%;">public static class __ImmutableJsonOptions__<br/>extends [JsonOptions](JsonOptions.md)
</span>
...
|-------------------------------------------------------------|-------------|
| ImmutableJsonOptions([JsonOptions](JsonOptions.md) options) |             |
...
| public [JsonOptions](JsonOptions.md) | [setAllowUnicode](#setallowunicode)(boolean val)                         |             |
...
| public [JsonOptions](JsonOptions.md) | [setInsertSpaces](#setinsertspaces)(boolean val)                         |             |
...
insertSpaces, allowTrailingComma, allowJson5Numbers, allowComments, allowUnicode, setAllowBooleanKeys, setUseSimd, duplicate, captureComments, prettyPrint, trackPosition, useSimd, setValidateUnicode, allowHexadecimalNumbers, allowSingleQuotedStrings, allowUnquotedKeys, setTrackPosition, validateUnicode
