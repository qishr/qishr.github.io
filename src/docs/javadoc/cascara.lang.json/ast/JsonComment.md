...
                io.github.qishr.cascara.lang.json.ast.JsonComment<br/>
<br/>
...
<span style="font-family: monospace; font-size: 80%;">public class __JsonComment__<br/>extends [JsonNode](JsonNode.md)
</span>
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| JsonComment(int line, int column, [String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) rawValue, [String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) stringValue, boolean multiLine) |             |
...
| public [JsonComment](JsonComment.md)                                                                                                                               | [setQuoteStyle](#setquotestyle)([QuoteStyle](../../cascara.common/lang/util/QuoteStyle.md) style)                                    |                                                             |
...
| public [String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html)                                                                | [getLexeme](#getlexeme)()                                                                                                            | Returns the original raw string as seen in the source file. |
...
<span style="font-family: monospace; font-size: 80%;">public [JsonComment](JsonComment.md) __setQuoteStyle__([QuoteStyle](../../cascara.common/lang/util/QuoteStyle.md) style)</span>
...
[JsonNode](../cascara.lang.json/ast/JsonNode.md#getcomments)
