...
                io.github.qishr.cascara.lang.json.ast.JsonProperty<br/>
<br/>
All Implemented Interfaces:<br/>
    [MapEntryAstNode](../../cascara.common/lang/ast/MapEntryAstNode.md)<[String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html), [JsonNode](JsonNode.md)>


----

<span style="font-family: monospace; font-size: 80%;">public class __JsonProperty__<br/>extends [JsonNode](JsonNode.md)
</span>
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| JsonProperty(int line, int column, [String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) key, [JsonNode](JsonNode.md) value) |                                                         |
| JsonProperty([String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) key, [JsonNode](JsonNode.md) value)                       | Convenience constructor for programmatic node creation. |
...
| public [JsonProperty](JsonProperty.md)                                                                                   | [setRaw](#setraw)([JsonNode](JsonNode.md) value)                                                                  |             |
...
| public [JsonProperty](JsonProperty.md)                                                                                   | [setValue](#setvalue)([JsonNode](JsonNode.md) value)                                                              |             |
...
<span style="font-family: monospace; font-size: 80%;">public [String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) __getKey__()</span>
...
<span style="font-family: monospace; font-size: 80%;">public [JsonProperty](JsonProperty.md) __setRaw__([JsonNode](JsonNode.md) value)</span>
...
<span style="font-family: monospace; font-size: 80%;">public [JsonProperty](JsonProperty.md) __setValue__([JsonNode](JsonNode.md) value)</span>
