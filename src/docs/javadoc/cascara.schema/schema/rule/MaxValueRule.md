...
                io.github.qishr.cascara.schema.rule.MaxValueRule<br/>
<br/>
...
<span style="font-family: monospace; font-size: 80%;">public class __MaxValueRule__<br/>extends [AbstractValidationRule](AbstractValidationRule.md)
</span>
...
<span style="font-family: monospace; font-size: 80%;">public double __getMax__()</span>
