...
                io.github.qishr.cascara.schema.rule.UniqueItemsRule<br/>
<br/>
...
<span style="font-family: monospace; font-size: 80%;">public class __UniqueItemsRule__<br/>extends [AbstractValidationRule](AbstractValidationRule.md)
</span>
