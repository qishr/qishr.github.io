...
                io.github.qishr.cascara.schema.rule.MaxItemsRule<br/>
<br/>
...
<span style="font-family: monospace; font-size: 80%;">public class __MaxItemsRule__<br/>extends [AbstractValidationRule](AbstractValidationRule.md)
</span>
...
| public int        | [getMaxItems](#getmaxitems)()                                                                                                                                                                                                                                                                               |             |
...
<span style="font-family: monospace; font-size: 80%;">public int __getMaxItems__()</span>
