...
                io.github.qishr.cascara.common.io.provider.HttpResourceProvider<br/>
<br/>

----

<span style="font-family: monospace; font-size: 80%;">public class __HttpResourceProvider__<br/>extends [AbstractResourceProvider](AbstractResourceProvider.md)
</span>
