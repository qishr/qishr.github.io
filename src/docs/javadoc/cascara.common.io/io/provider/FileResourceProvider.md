...
                io.github.qishr.cascara.common.io.provider.FileResourceProvider<br/>
<br/>

----

<span style="font-family: monospace; font-size: 80%;">public class __FileResourceProvider__<br/>extends [AbstractResourceProvider](AbstractResourceProvider.md)
</span>
