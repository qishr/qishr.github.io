...
        io.github.qishr.cascara.ui.vsix.VsixPreview<br/>
<br/>

----

<span style="font-family: monospace; font-size: 80%;">public class __VsixPreview__</span>
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|-------------|
| public static [VsixPreview](VsixPreview.md)                                                                                                                                                   | [fromJson](#fromjson)([String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) jsonString) |             |
...
<span style="font-family: monospace; font-size: 80%;">public static [VsixPreview](VsixPreview.md) __fromJson__([String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) jsonString)</span>
