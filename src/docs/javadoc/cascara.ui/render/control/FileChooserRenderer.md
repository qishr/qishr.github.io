Package [io.github.qishr.cascara.ui.render.control](index.md)
...
                        io.github.qishr.cascara.ui.render.control.FileChooserRenderer<br/>
<br/>
All Implemented Interfaces:<br/>
    [ScalarEditorRenderer](../../api/render/ScalarEditorRenderer.md)


----

<span style="font-family: monospace; font-size: 80%;">public class __FileChooserRenderer__<br/>extends [AbstractScalarRenderer](../AbstractScalarRenderer.md)
</span>
...
<span style="font-family: monospace; font-size: 80%;">public [Node](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.graphics/javafx/scene/Node.html) __render__([Labeled](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.controls/javafx/scene/control/Labeled.html) view, [Observable](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.base/javafx/beans/Observable.html) data, [DataProvider](../../api/data/DataProvider.md) dataProvider, [FieldMetadata](../../form/FieldMetadata.md) meta)</span>
...
<span style="font-family: monospace; font-size: 80%;">protected [Node](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.graphics/javafx/scene/Node.html) __createPathField__([ObjectProperty](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.base/javafx/beans/property/ObjectProperty.html) property, [FieldMetadata](../../form/FieldMetadata.md) meta)</span>
