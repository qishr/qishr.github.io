...
| public [TabularData](../../cascara.common/data/TabularData.md)                                                                                                                                                | [getSelectedRow](#getselectedrow)()                                                                                                                                                                                                                  |             |
...
| public [ObservableList](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.base/javafx/collections/ObservableList.html)<? extends [TabularData](../../cascara.common/data/TabularData.md)> | [getItems](#getitems)()                                                                                                                                                                                                                              |             |
...
<span style="font-family: monospace; font-size: 80%;">public [TabularData](../../cascara.common/data/TabularData.md) __getSelectedRow__()</span>
...
<span style="font-family: monospace; font-size: 80%;">public [ObservableList](https://docs.oracle.com/en/java/java-components/javafx/25/docs/javafx.base/javafx/collections/ObservableList.html)<? extends [TabularData](../../cascara.common/data/TabularData.md)> __getItems__()</span>
